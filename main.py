...
medications = pd.read_csv('datasets/disease_medication.csv')
diets = pd.read_csv("datasets/disease_diet.csv")
    ...
    if request.method == 'POST':
        ...
        if symptoms =="Symptoms":
            ...
            return render_template('index.html', predicted_disease=predicted_disease, dis_des=dis_des,
                                   my_precautions=my_precautions, my_medications=my_medications, my_diet=my_diet,
                                   workout=workout)
...
# symptoms view funtion and path
@app.route('/developer')
def developer():
